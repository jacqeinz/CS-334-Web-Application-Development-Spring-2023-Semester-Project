...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const apiRequest = fetch("http://jacqiec.pythonanywhere.com/api/getMilkshakes");
  apiRequest
...
function goToFlavors(type, price) {
  ...
  window.location.href = "flavors.html?type=milkshake"+"&price="+ price +"+&name=" + type;
}

function addToCart(type, price) {
  console.log(type, price);
  window.location.href="shoppingcart.html?type=milkshake"+"&price="+ price +"+&name=" + type+"&flavors="+" ";
}
