...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const apiRequest = fetch("/api/getSmoothies");
  apiRequest
...
function goToFlavors(type) {
  console.log(type);
  window.location.href = "flavors.html?type=smoothie&id=" + type;
}

function addToCart(type) {
  console.log(type);
  window.location.href="shoppingcart.html?type=smoothie&id="+type;
}
